        ...
        <div className="card" style={{ marginBottom: 'var(--space-xl)' }}>
          ...
          <div style={{ display: 'flex', gap: 'var(--space-xl)', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: '200px' }}>
              ...
              {editing ? (
                ...
                <div style={{ textAlign: 'center', width: '100%' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'var(--space-sm)', marginBottom: 'var(--space-xs)' }}>
                  ...
                  <p className="profile-email" style={{ margin: 0, marginBottom: 'var(--space-sm)' }}>{profile?.email}</p>
            ...
            <div style={{ flex: 1, minWidth: '300px' }}>
              <h3 style={{ marginBottom: 'var(--space-lg)', color: 'var(--color-text-primary)' }}>Activity Statistics</h3>
              ...
              {stats ? (
                ...
                <div className="loading" style={{ textAlign: 'left', padding: 'var(--space-lg) 0' }}>Loading stats...</div>
              )}
            </div>
          </div>
